    ...
    >
      <div className="flex items-center justify-center gap-1">
        <Link
          ...
          className="text-foreground hover:text-primary whitespace-nowrap transition-colors"
        >
          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                ...
                'lg:border-border lg:bg-background lg:rounded-sm lg:border lg:shadow-md',
                isActive
                  ? 'max-lg:flex'
