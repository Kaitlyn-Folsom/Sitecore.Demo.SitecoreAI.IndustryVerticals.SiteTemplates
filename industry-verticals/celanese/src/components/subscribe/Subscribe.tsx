          ...
          <form className="w-full md:max-w-lg" action="">
            ...
            <div className="relative">
              <input
                ...
                className="bg-background ring-foreground/5 text-foreground placeholder:text-foreground/70 h-12 w-full rounded-sm ps-5 pe-32 ring-1 focus:ring-2 focus:outline-none md:h-14"
              />

              <button
                type="submit"
                className="bg-accent text-background group-[.container-dark-background]:bg-background group-[.container-dark-background]:text-brand-teal-deep absolute top-1/2 right-2 h-9 -translate-y-1/2 rounded-sm px-4 text-sm font-semibold hover:opacity-90 focus-visible:ring-2 focus-visible:outline-none md:right-3 md:h-10 md:px-5"
              >
    ...
    <section className={`component subscribe-banner group ${styles ?? ''}`} id={id || undefined}>
      ...
      <div className="max-w-sm">
        ...
        <form className="w-full" action="">
          ...
          <button
            type="submit"
            className="bg-accent text-background group-[.container-dark-background]:bg-background group-[.container-dark-background]:text-brand-teal-deep mt-3 inline-flex h-12 w-full items-center justify-center rounded-sm font-semibold tracking-widest uppercase hover:opacity-90 md:h-12"
          >
            {t('button_text') || 'Subscribe'}
          </button>
