  ...
  return (
    ...
    >
      <Pagination.PrevPage
        ...
        className="bg-background-accent rounded-sm px-3 py-2 data-[current=true]:hidden md:px-4 md:py-3"
      >
          ...
          Pagination.paginationLayout(pagination, {
            ...
            type === 'page' ? (
              <Pagination.Page
                ...
                page={page as number}
                onClick={(e) => e.preventDefault()}
                className={`mx-1 rounded-sm px-3 py-2 md:px-4 md:py-3 ${
                  page === currentPage ? 'bg-interactive text-background' : 'bg-background-accent'
                }`}
              >
                {page}
              </Pagination.Page>
