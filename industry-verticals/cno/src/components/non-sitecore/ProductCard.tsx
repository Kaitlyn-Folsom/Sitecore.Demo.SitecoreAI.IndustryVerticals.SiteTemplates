...
export const ProductCard = ({ product, url, className }: ProductCardProps) => {
  ...
  return (
    <Link href={url} passHref>
      <div
        className={`border-border hover:border-interactive/30 flex min-h-123 w-full flex-col overflow-hidden border transition-colors ${className}`}
      >
        {/* Product Image */}
        ...
        <div className="bg-background flex grow-1 flex-col items-start px-5 pt-3 pb-9 text-left">
          ...
          <StarRating
            ...
            showOnlyFilled
            className="!text-interactive mt-1 mb-5"
          />
