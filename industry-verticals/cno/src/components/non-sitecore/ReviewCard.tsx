...
const ReviewCard = (props: ReviewCardProps) => {
  return (
    <>
      ...
      <div className="px-5">
        <div className="bg-background border-border relative -top-15 flex min-h-70 flex-col items-center justify-between rounded-sm border p-8 text-center shadow-sm">
          {/* Image */}
